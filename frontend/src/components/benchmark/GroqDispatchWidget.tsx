 ...
 * try again. Like Google there's no token budget to show a progress bar
 * against — Groq's constraint is a per-day request cap enforced by Groq
 * itself, so this only ever shows active/inactive. */
