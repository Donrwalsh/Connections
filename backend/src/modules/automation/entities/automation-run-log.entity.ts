 ...
 * Google-burn and Groq-burn legs (their *FreeDispatchService.start() each
 * check up front whether every model is already RPD-held); the OpenAI
 * mini-burn leg only ever reports "started", "alreadyActive", or "error". */
