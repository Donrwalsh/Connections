...
// Backs getRecentActivity's unfiltered "ORDER BY startedAt DESC LIMIT 100"
// — the two composite indexes above both lead with strategyName, so neither
// can serve a global (cross-strategy) sort on startedAt alone.
